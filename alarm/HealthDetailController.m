...
- (void)viewDidLoad {
    ...
    UITextView *descTextView = [[UITextView alloc] initWithFrame:CGRectMake(10, imageView.frame.origin.y+imageView.frame.size.height+10, self.view.frame.size.width, 100)];
    descTextView.font = [UIFont fontWithName:@"AppleGothic" size:12.0];
    descTextView.text = @"這裡是常識內容\n這裡是常識內容\n這裡是常識內容\n這裡是常識內容";
